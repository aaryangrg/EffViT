...
import math
import os
from efficientvit.clscore.data_provider.MiniImageNet import MiniImageNet, MiniImageNetV2
from efficientvit.clscore.data_provider.CustomDataset import CustomImageDataset

import torchvision.transforms as transforms
from torchvision.datasets import ImageFolder

from efficientvit.apps.data_provider.subset_base import DataProviderSubset
...
__all__ = ["ImageNetDataProviderSubset", "ImageNetDataProviderSubsetV2"]


class ImageNetDataProviderSubset(DataProviderSubset):
    name = "imagenet"
...
class ImageNetDataProviderSubsetV2(DataProviderSubset):
    name = "imagenet"
    ...
    def build_datasets(self) -> tuple[any, any, any]:
        ...
        train_dataset = MiniImageNetV2(os.path.join(self.data_dir,"train"), transform = train_transform, type = "train")
        test_dataset = MiniImageNetV2(os.path.join(self.data_dir,"validation"), transform = valid_transform, type = "validation")
